...
Phase 4 is Network Framework. Phase 4.0, Phase 4.1, and Phase 4.2 are complete.
Continue with Phase 4.3, then advance through the Phase 4 sub-phases in roadmap order unless the owner explicitly changes priorities.
