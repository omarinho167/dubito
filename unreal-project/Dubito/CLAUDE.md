...
Phase 4 is Network Framework. Phase 4.0, Phase 4.1, Phase 4.2, Phase 4.3, Phase 4.4, and Phase 4.5 are complete.
Continue with Phase 4.6, then advance through the Phase 4 sub-phases in roadmap order unless the owner explicitly changes priorities.
